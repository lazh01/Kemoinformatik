...
\input{\modInputPrefix/out/044_dg_0_11100_f_0_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-29-0)] (v-29-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 51{ 'p_{0,10}' }, 'Aldol Addition <-', { 'Glycolaldehyde' 'p_{0,3}' }
\node[modStyleDGHyperEdge, at=(v-coord-51-0)] (v-51-0) {$\mathrm{f\ 1,\ r_{3}}$};
...
\path[modStyleDGHyperConnector] (v-1-0) to node[auto, swap] {$\mathrm{f\ 1}$} (v-1-0-IOFlow);
\end{tikzpicture}%
